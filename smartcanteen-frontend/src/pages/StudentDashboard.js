  ...
  return (
    <div className="st-dashboard">
      <header className="st-header">
        <h1>SmartCanteen Student Portal</h1>
      ...
      <section className="st-how">
        <h2>How Students Use SmartCanteen ??</h2>
        <div className="st-steps">
          <div className="st-step">1. Select Food</div>
          <div className="st-step">2. Place Order</div>
          <div className="st-step">3. Receive Token</div>
          <div className="st-step">4. Collect Food</div>
        </div>
      </section>
