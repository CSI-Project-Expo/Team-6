  ...
  return (
    <div className="ha-dashboard">
      ...
      <section className="ha-hero">
        ...
        <p>Manage menu, validate tokens and track customer orders efficiently.</p>
      </section>
      ...
      <section className="ha-how">
        ...
        <div className="ha-steps">
          <div className="ha-step">1️⃣ Manage Menu</div>
          <div className="ha-step">2️⃣ Receive Orders</div>
          <div className="ha-step">3️⃣ Validate Token</div>
          <div className="ha-step">4️⃣ Update Status</div>
          <div className="ha-step">5️⃣ Serve Food</div>
        </div>
      </section>
